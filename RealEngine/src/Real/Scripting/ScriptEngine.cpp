...
namespace Real {
	...
	static std::unordered_map<std::string, ScriptFieldType> s_ScriptFieldTypeMap =
	{
		...
		{ "Real.Vector2", ScriptFieldType::Vector2 },
		{ "Real.Vector3", ScriptFieldType::Vector3 },
		{ "Real.Vector4", ScriptFieldType::Vector4 },

		{ "Real.Entity", ScriptFieldType::Entity },
	};
	...
	void ScriptEngine::Init()
	{
		...
		bool status = LoadAssembly("Resources/Scripts/Real-ScriptCore.dll");
		if (!status)
		{
		...
		s_Data->EntityClass = ScriptClass("Real", "Entity", true);
	}
	...
	void ScriptEngine::InitMono()
	{
		...
		MonoDomain* rootDomain = mono_jit_init("RealJITRuntime");
	...
	bool ScriptEngine::LoadAssembly(const std::filesystem::path& filepath)
	{
		...
		s_Data->AppDomain = mono_domain_create_appdomain("RealScriptRuntime", nullptr);
	...
	void ScriptEngine::LoadAssemblyClasses()
	{
		...
		int32_t numTypes = mono_table_info_get_rows(typeDefinitionsTable);
		MonoClass* entityClass = mono_class_from_name(s_Data->CoreAssemblyImage, "Real", "Entity");
