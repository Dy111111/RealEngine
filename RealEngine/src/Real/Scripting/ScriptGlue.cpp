...
#define RE_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Real.InternalCalls::" #Name, Name)
	...
	{
		RE_CORE_WARN("Value: {0}", *parameter);
		...
		([]()
			{
				...
				std::string managedTypename = fmt::format("Real.{}", structName);
